...
class XdrClient : public QObject
{
    ...
    Q_PROPERTY(int wam READ wam NOTIFY qualityChanged)
    Q_PROPERTY(int usn READ usn NOTIFY qualityChanged)
...
private:
    ...
    void markConnectionActivity();
    void closeLostUsbConnection(const QString &message);
    ...
    QTimer connectionWatchdogTimer_;
    ...
    QString lastLine_;
    QString pendingDisconnectStatus_;
